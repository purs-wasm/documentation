              ...
              , HH.div [ HP.class_ $ ClassName "flex items-center gap-4 sm:gap-5" ]
                  ...
                  , HH.a
                      ...
                      [ HH.div
                          ...
                          , HH.span [ HP.class_ $ ClassName "font-mono hover:underline" ] [ HH.text $ Fmt.fmt @"v{version}" { version: pursWasmVersion } ]
                          ]
                      ]
                  ]
              ]
  ...
  themeToggle st =
    HH.div [ HP.class_ $ ClassName "flex items-center gap-2" ]
      [ HH.span [ HP.class_ $ ClassName "hidden sm:flex" ]
          [ themeIcon "Use light theme" (Base.asset "img/sun-icon.svg") (not st.dark) (st.setTheme Light) ]
      , HH.button
      ...
      , HH.span [ HP.class_ $ ClassName "hidden sm:flex" ]
          [ themeIcon "Use dark theme" (Base.asset "img/moon-icon.svg") st.dark (st.setTheme Dark) ]
      ]
